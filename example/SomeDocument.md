...
[Cheatsheet specific to Markdown Here](./Markdown-Here-Cheatsheet) if that's
what you're looking for. You can also check out
...
_Markdown Here_ supports them. They are an easy way of adding tables to your
...
(Technical note: _Markdown Here_ uses GFM line breaks, so there's no need to use
...
Referencing a bug by #bugID in your git commit links it to the slip. For example
#1.
